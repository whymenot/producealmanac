...
*/
	...
	public void populateMap() {		
		...
		putEntry("Blueberries are high in antioxidants and very nutritious; ranging in flavor from tart and sour to sweet. While they can be baked into pies or other deserts, eating them raw provides the greatest nutritional benefits.", "Ripe blueberries will keep in the refrigerator for upto 3 day; wash immediately before use", "ripe blueberries should be firm and have a lively, uniform hue colored with a whitish bloom", "blueberries", FRUITS);
