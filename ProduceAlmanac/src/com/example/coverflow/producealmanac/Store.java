...
public class Store {
	...
	public static void buildMaps(){
		...
		String[] berkeleyBowlActive = {"garlic", "carrots", "onion", "parsnip", "broccoli", "cauliflower", "asian greens","lettuce", "spinach", "eggplant", "summer squash", "cucumber", "bell peppers"};//, "bell peppers", "asparagus", "celery"};, "kiwifruit", "strawberries", "blueberries"};
